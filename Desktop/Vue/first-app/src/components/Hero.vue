...
defineProps({
    title: {
        type: String,
        default : "Lush plant that transforms your environment to something green" 
    }
})
        ...
        <div class="w-full sm:w-8/12 mb-10">
            <div class="container mx-auto h-full sm:p-10">
                ...
                <header class="container px-4 lg:flex mt-10 items-center h-full lg:mt-0">
                    <div class="w-full">
                        <h1 class="text-4xl lg:text-6xl font-bold">Find your <span class="text-green-700">greeny</span>
                            stuff for your room</h1>
                        <div class="w-20 h-2 bg-green-700 my-4"></div>
                        <p class="text-xl mb-10">{{ title }}</p>
                        <button class="bg-green-500 text-white text-2xl font-medium px-4 py-2 rounded shadow">Learn
                            More</button>
                    </div>
                </header>
            </div>
